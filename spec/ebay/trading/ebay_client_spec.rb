...
describe Ebay::Trading::EbayClient do
  ...
  DO_BASIC_CONTEXT = true
  DO_ITEM_CONTEXT = true
  ...
  if (DO_BASIC_CONTEXT) then
    context 'basic tests of the library' do
  ...
  if (DO_ITEM_CONTEXT) then
    context "item related tests" do
